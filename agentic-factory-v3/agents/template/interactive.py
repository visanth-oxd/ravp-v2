"""
Interactive session with the Template Agent.

Run with: python agents/template/interactive.py
...
When you copy this template to a new agent, keep this interactive.py and
...
def main():
    print("Template Agent – interactive session")
