"""
Interactive session with the My Agent Agent.

Run with: python agents/my_agent/interactive.py
...
When you copy this my_agent to a new agent, keep this interactive.py and
...
def main():
    print("My Agent Agent – interactive session")
