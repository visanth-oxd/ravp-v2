"""
Test Agent Agent – uses RegulatedAgent from SDK.

Copy this test_agent to create a new agent.
Replace all "test_agent" references with your agent name.
"""
...
AGENT_ID = "test_agent"  # Change this to your agent ID


class TestAgent:
    """
    Test Agent Agent using RegulatedAgent SDK.
    ...
    def __init__(self, control_plane_url: str | None = None):
        """
        Initialize the test_agent agent.
...
"""
    ...
    def answer(self, user_input: str) -> str | None:
        ...
        if lower == "help":
            help_text = (
                "Test Agent Agent – interactive session.\n\n"
                "Commands:\n"
...
# Factory function
def create_agent(control_plane_url: str | None = None) -> TestAgent:
    """
    Factory function to create TestAgent instance.
    ...
    Returns:
        TestAgent instance
    """
    return TestAgent(control_plane_url=control_plane_url)
